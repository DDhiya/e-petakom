...
<main>
    ...
    <aside>
        ...
        <div class="sidebar__container">
            ...
            <a href="{{ route('activities') }}" class="sidebar__btn active-sidebar-btn">
    ...
    <div class="container">
      <table style="width:100%">
        <tr>
			 <h1 style="text-align: center;">Edit Activities</h1>
       <br>
		</a></button>
	<fieldset>
		     <br>
			 <table class="center">
				...
				<td><td>
					<p>
					<td>
					<label for="Activities ID">Activities ID:</label>
					</td>
					<td>
					<input type="text" class="form-control" name="activitiesid" id="activitiesid" value="{{ $activities[0]->activitiesid }}" readonly> 
					<td>
					</p>
				</td>
                </tr>
				...
				<td><td>
					<p>
					<td>
					<label for="Activities Image">Activities Image:</label>
					</td>
					<td>
					<input type="text" class="form-control" name="activitiesimage" id="activitiesimage" value="{{ $activities[0]->activitiesimage }}">  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="activitiestittle" id="activitiestittle" value="{{ $activities[0]->activitiestittle }}">  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="quantity" id="quantity" value="{{ $activities[0]->quantity }}">  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="description" id="description" value="{{ $activities[0]->description }}" >  
					</td>
					</p>
				</td>
				</tr>
                ...
                <td><td>
					...
					<td>
					<input type="date" class="form-control" name="date" id="date" value="{{ $activities[0]->date }}" >  
					</td>
					</p>
				</td>
				</tr>
                ...
                <td><td>
					...
					<td>
					<input type="time" class="form-control" name="time" id="time" value="{{ $activities[0]->time }}" >  
					</td>
					</p>
				</td>
				</tr>
