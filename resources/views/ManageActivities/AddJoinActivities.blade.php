  ...
  <center>
    ...
    <div class="container">
      <table style="width:100%">
        <tr>
			 <h1 style="text-align: center;">Join Activities</h1>
        </br>
        <fieldset>    
		     <br>

			 <table class="center">
				<form action="ManageActivities2" method="POST" >
                @csrf
				...
				<td><td>
					<p>
					<td>
					<label for="Matric ID">Matric ID:</label>
					</td>
					<td>
                  
					<input type="int" name="matricid" value="<?php echo "$logged_user" ?>" readonly>
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input class="custom-control-input" type="radio" value="{{$data->activitiestittle }}" id="{{$data->activitiestittle }}" name="activitiestittle">
                    <label class="custom-control-label" for="{{$data->activitiestittle }}">{{$data->activitiestittle }}</label>
                </div>
     ...
     @endforeach
			...
			<a href="ViewJoinActivities" class="btn btn-success">View Join Activities<class="nav-link  @if(url()->current() ===  URL::to('/ViewJoinActivities'))
		active
		@endif">
		</a>
