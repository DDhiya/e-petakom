  ...
  <center>
    ...
    <div class="container">
      <table style="width:100%">
        <tr>
			 <h1 style="text-align: center;">Add Activities</h1>
        </br>
        <a href="Participations" class="btn btn-success">Participations<class="nav-link  @if(url()->current() ===  URL::to('/Participations'))
		active
		@endif">
		</a>
        <fieldset>   
			 ...
			 <table class="center">
				<form action="ManageActivities" method="POST" >
                @csrf
				...
				<td><td>
					...
					<td>
					<input type="text" name="activitiesimage">
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" name="activitiestittle">
					</td>
					</p>
				</td>
				</tr>
			...
			<a href="ViewActivities" input type="submit" class="btn btn-success" name="Submit" id="Submit" value="Submit" method="post"class="btn btn-success">View Activities<class="nav-link  @if(url()->current() ===  URL::to('/ViewActivities'))
		active
		@endif">
		</a>
        <a href="AddJoinActivities" class="btn btn-success">Join Activities<class="nav-link  @if(url()->current() ===  URL::to('/AddJoinActivities'))
		active
		@endif">
		</a>
