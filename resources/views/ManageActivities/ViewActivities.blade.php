...
<main>
    ...
    <section class="middle__container">
        @yield('content')
         ...
         <center>
			 <h1 style="text-align: center;">Activities List</h1>
       </br>
			<table id="bulletin">
			<tr>
				<br><br>
   ...
   <tr>
           <td>&nbsp&nbsp{{$data->activitiesid }}</td>
            <td>&nbsp&nbsp{{$data->activitiesimage}}</td>
            <td>&nbsp&nbsp{{$data->activitiestittle}}</td>
            <td>&nbsp&nbsp{{$data->quantity}}</td>
            <td>&nbsp&nbsp{{$data->description}}</td>
            <td>&nbsp&nbsp{{$data->date}}</td>
            <td>&nbsp&nbsp{{$data->time}}</td>
			<td><a href="c_edit/{{$data->activitiesid}}" class="btn btn-success">Edit</a><a href="c_delete/{{$data->activitiesid}}" class="btn btn-danger">Delete</a></td>
    </tr>
     @endforeach
		</table><br>
    <a href="AddActivities" class="btn btn-success">Add Activities<class="nav-link  @if(url()->current() ===  URL::to('/AddActivities'))
	active
    @endif">
		</a> 
  </center>
