...
<center>
    ...
    <div class="container">
      <table style="width:100%">
        <tr>
			 <h1 style="text-align: center;">Edit Bulletin</h1>
       <br>
		</a></button>
	<fieldset>
		     <br>
			 <table class="center">
				...
				<td><td>
					<p>
					<td>
					<label for="Bulletin ID">Bulletin ID:</label>
					</td>
					<td>
					<input type="text" class="form-control" name="bulletinID" id="bulletinID" value="{{ $bulletins[0]->bulletinID }}" readonly> 
					<td>
					</p>
				</td>
                </tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="bulletinImage" id="bulletinImage" value="{{ $bulletins[0]->bulletinImage }}">  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="title" id="title" value="{{ $bulletins[0]->title }}">  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="description" id="description" value="{{ $bulletins[0]->description }}" >  
					</td>
					</p>
				</td>
				</tr>
