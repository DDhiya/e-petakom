...
<center>
    ...
    <div class="container">
      <table style="width:100%">
        <tr>
			 <h1 style="text-align: center;">Add Bulletin</h1>
        </br>
        ...
        <fieldset>
			 ...
			 <table class="center">
				<form action="ManageBulletin" method="POST" >
                @csrf
				...
				<td><td>
					...
					<td>
					<!-- <input type="text" name="bulletinImage"> -->
                    <!-- upload image-->
                    <input class="form-control @error('image') is-invalid @enderror" name="bulletinImage" 
                    type="file" id="bulletinImage" enctype="multipart/form-data"> </br>
                    @error('image')
			...
			<a href="ViewBulletin" class="btn btn-success">View Bulletin<class="nav-link  @if(url()->current() ===  URL::to('/ViewBulletin'))
		active
		@endif">
		</a>
			</p>
