...
<main>
    ...
    <aside>
        ...
        <div class="sidebar__container">
            ...
            <a href="{{ route('prop') }}" class="sidebar__btn active-sidebar-btn">
...
<center>
	...
	<fieldset>
		     <br>
			 <table class="center">
				<form action="/propup" method="POST">
                @csrf
				<center>
				<td><td>
					<p>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="Author" id="Author" value="{{ $prop[0]->Author }}">  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					<p>
					<td>
					<label for="MatricID">MatricID:</label>
					</td>
					<td>
					<input type="text" class="form-control" name="MatricID" id="MatricID" value="{{ $prop[0]->MatricID }}">  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="Title" id="Title" value="{{ $prop[0]->Title }}" >  
					</td>
					</p>
				</td>
				</tr>
				...
				<td><td>
					...
					<td>
					<input type="text" class="form-control" name="File" id="File" value="{{ $prop[0]->File }}" >  
					</td>
					</p>
				</td>
				</tr>
